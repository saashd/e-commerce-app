...
import {Drawer, IconButton, List, ListItemButton, ListItemIcon, ListItemText, ListSubheader} from "@mui/material";
...
export default function Sidebar() {
    ...
    return (<div>
            <IconWrapper onClick={toggleDrawer}><MenuIcon/></IconWrapper>
            <Drawer
                anchor={'left'}
                open={open}
